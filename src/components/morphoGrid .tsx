                    ...
                    <div className="grid rotate-x-[55deg] -translate-x-1/12 -translate-y-3/12 -rotate-y-[10deg] scale-[130%] rotate-z-[35deg] border-t border-r border-black/15 dark:border-white/15 grid-cols-20 grid-rows-20">
                        ...
                        {gridItems.map((_, index) => (
                            <div key={index} className="border border-t-0 border-r-0 grid grid-cols-2 grid-rows-2 w-20 h-20 relative select-none border-black/15 dark:border-white/15">
                                <div className='bg-transparent hover:bg-green-400 transition-colors duration-[1s] hover:duration-[0s] border-r border-black/15 dark:border-white/15'></div>
                                <div className='bg-transparent hover:bg-purple-400 transition-colors duration-[1s] hover:duration-[0s]'></div>
                                <div className='bg-transparent hover:bg-orange-400 transition-colors duration-[1s] hover:duration-[0s] border-t border-r border-black/15 dark:border-white/15'></div>
                                <div className='bg-transparent hover:bg-red-400 transition-colors duration-[1s] hover:duration-[0s] border-t border-black/15 dark:border-white/15'></div>
